...
const Monkeytype = () => {
  ...
  // 🕵️‍♂️ Kita ambil username & url dari constant yang sudah kamu ubah sebelumnya
  const { username, monkeytype_url, is_active } = MONKEYTYPE_ACCOUNT;
  ...
  return (
    <section className="space-y-2">
      ...
      <SectionSubHeading>
        ...
        >
          {/* 👇 Sekarang otomatis menampilkan username kamu (CelvinAndraM) */}
          {username}
        </Link>
      </SectionSubHeading>
