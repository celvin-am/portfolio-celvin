...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Celvin Andra Maulana's Portfolio App regarding TikTok API usage",
      ...
      <div className="mt-8 space-y-8 leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            the property of Celvin Andra Maulana. Content displayed through the TikTok
